...
const __quickstart = paths.join(__profiler, ".github/scripts/quickstart")
...
const target = paths.join(__profiler, `source/${{plugin:"plugins/community", template:"templates"}[mode]}`, name)

...
import url from "url"
import setup from "../../source/app/profiler/setup.mjs"
...
const __node_modules = paths.join(paths.join(__profiler, "node_modules"))
const __web = paths.join(paths.join(__profiler, "source/app/web/statics"))
...
fs.writeFile(paths.join(__preview, ".hosted"), JSON.stringify({by: "profiler", link: "https://github.com/lowlighter/profiler"}))
//Embed
{

...
Spotify does not have _personal tokens_, so it makes the process a bit longer because it is required to follow the [authorization workflow](https://developer.spotify.com/documentation/general/guides/authorization-guide/)... Follow the instructions below for a _TL;DR_ to obtain a `refresh_token`.
...
Extract the _playlist_ URL of the playlist you want to share.

;(function({axios, faker, ejs} = {axios: globalThis.axios, faker: globalThis.faker, ejs: globalThis.ejs}) {
  ...
  globalThis.placeholder = async function(set) {
    ...
    const data = {
      ...
      //Meta-data
      meta: {version: set.version, author: "nextlinux", generated: new Date().toGMTString().replace(/GMT$/g, "").trim()},
      //Animated
      animated: false,
      //Display size
              ...
              list: [
                {
                  ...
                  entities: {
                    mentions: [{start: 22, end: 33, username: "nextlinux"}],
                  },
                  text: 'Checkout profiler from  <span class="mention">@nextlinux</span>  !  <span class="hashtag">#GitHub</span> ',
                  mentions: ["nextlinux"],
                },
              ...
              repositories: [
                {
                  ...
                  node: {
                    description: "📊 An image generator with 20+ profiler about your GitHub account such as activity, community, repositories, coding habits, website performances, music played, starred topics, etc. that you can put on your profile or elsewhere !",
            ...
            starlists: {
              lists: new Array(Number(options["starlists.limit"])).fill(null).map(_ => ({
                ...
                repositories: new Array(Number(options["starlists.limit.repositories"])).fill(null).map((_, i) => ({
                  description: !i
                    ? "📊 An image generator with 20+ profiler about your GitHub account such as activity, community, repositories, coding habits, website performances, music played, starred topics, etc. that you can put on your profile or elsewhere !"
                    : faker.lorem.sentence(),
                  name: !i ? "nextlinux/profiler" : `${faker.random.word()}/${faker.random.word()}`,
                })),
              })),
            },
          })

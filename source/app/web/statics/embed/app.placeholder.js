              ...
              list: [
                {
                  ...
                  text: 'Checkout profiler from  <span class="mention">@lowlighter</span>  !  <span class="hashtag">#GitHub</span> ',
                  mentions: ["lowlighter"],
                },
            ...
            starlists: {
              lists: new Array(Number(options["starlists.limit"])).fill(null).map(_ => ({
                ...
                repositories: new Array(Number(options["starlists.limit.repositories"])).fill(null).map((_, i) => ({
                  ...
                  name: !i ? "lowlighter/profiler" : `${faker.random.word()}/${faker.random.word()}`,
                })),
              })),
            },
          })
